...
class Menu:
    ...
    def setup(self):
        ...
        self.main_rect = pygame.Rect(SCREEN_WIDTH / 2 - self.widht / 2, self.menu_top, self.widht, self.total_height)
    ...
    def show_entry(self, text_surf, amount, top, selected):
        ...
        # background
        bg_rect = pygame.Rect(self.main_rect.left, top, self.widht, text_surf.get_height() + (self.padding * 2))
