...
class CameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        # zoom
        self.zoom_scale = 1
        self.zoom_scale_max = 2.4
        self.zoom_scale_min = 0.6
    ...
    def zoom_keyboard_control(self):
        ...
        if keys[pygame.K_q]:
            self.zoom_scale += 0.1
            if self.zoom_scale > self.zoom_scale_max: self.zoom_scale = self.zoom_scale_max
        if keys[pygame.K_e]:
            self.zoom_scale -= 0.1
            if self.zoom_scale < self.zoom_scale_min: self.zoom_scale = self.zoom_scale_min
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEWHEEL:
            ...
            if camera_group.zoom_scale < camera_group.zoom_scale_min: camera_group.zoom_scale = camera_group.zoom_scale_min
            if camera_group.zoom_scale > camera_group.zoom_scale_max: camera_group.zoom_scale = camera_group.zoom_scale_max
