...
public class Breakfast {
    ...
    public static ErrorOr<Breakfast> Create(
        ...
        if (name.Length is < MinNameLength or > MaxNameLength) errors.Add(Errors.Breakfast.InvalidName);
        if (description.Length is < MinDescriptionLength or > MaxDescriptionLength) errors.Add(Errors.Breakfast.InvalidDescription);
