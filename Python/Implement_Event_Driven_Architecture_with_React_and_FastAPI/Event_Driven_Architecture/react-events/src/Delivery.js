    ...
    return <div className="row w-100">
        ...
        <div className="col-12 mb-5">
            <div className="progress">
                { state.status !== "ready" ? 
                <div className={state.status === "active" 
                ...
                <div className={state.status === "collected" 
                ? "progress-bar bg-success progress-bar-striped progress-bar-animated" 
                : "progress-bar bg-success"} 
                role="progressbar" style={{width: "50%"}}>
                </div>
        ...
        <div className="col-3">
            <div className="card">
                ...
                <form className="card-body" onSubmit={e => submit(e, "PICKUP_PRODUCTS")}>
                    <div className="mb-3">
                        <input className="form-control" type="number" name="purchase_price" placeholder="Purchase Price" />
                        <input className="form-control" type="number" name="quantity" placeholder="Quantity" />
                    </div>
                    <button className="btn btn-primary">Submit</button>
                </form>
            </div>
        ...
        <div className="col-3">
            <div className="card">
                ...
                <form className="card-body" onSubmit={e => submit(e, "DELIVER_PRODUCTS")}>
                    <div className="mb-3">
                        <input className="form-control" type="number" name="sell_price" placeholder="Sell Price" />
                        <input className="form-control" type="number" name="quantity" placeholder="Quantity" />
                    </div>
                    <button className="btn btn-primary">Submit</button>
                </form>
        ...
        <code className="col-12 mt-4">{JSON.stringify(state, null, "\t")}</code>
    </div>
};
